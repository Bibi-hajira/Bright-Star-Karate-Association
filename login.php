...
<html>
  <head>
    <title>Training login Form</title>
  ...
  <body>
    <div class="testbox">
      <form method="POST">
        ...
        <div class="btn-block">
        <a href="register.php" >Don't Have Account? Click here..</a></span></label>
        </div>
      </form>
    ...
    if($_POST)
    {
       ...
       $query="SELECT email,password from register where email='".$email."' and  password='".$pass1."'";
